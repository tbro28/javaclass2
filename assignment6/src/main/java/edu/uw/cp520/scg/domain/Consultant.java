 ...
 * @author Tim Brown
 */
public class Consultant implements Comparable<edu.uw.cp520.scg.domain.Consultant>, Serializable {
    ...
    private static Logger log = LoggerFactory.getLogger(edu.uw.cp520.scg.domain.Consultant.class);
    ...
    private static class SerializationProxy implements Serializable {
        ...
        SerializationProxy( final edu.uw.cp520.scg.domain.Consultant consultant) {
        ...
        private Object readResolve() {
            ...
            return new edu.uw.cp520.scg.domain.Consultant(serName);
        }
    }
...
/*        return "Consultant{" +
    ...
    public boolean equals(Object o) {
        ...
        edu.uw.cp520.scg.domain.Consultant that = (edu.uw.cp520.scg.domain.Consultant) o;
     ...
     */
    @Override
    public int compareTo(edu.uw.cp520.scg.domain.Consultant o) {
        int diff = 0;
