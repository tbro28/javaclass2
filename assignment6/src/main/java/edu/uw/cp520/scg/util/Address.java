 ...
 * @author Tim Brown
 */
public final class Address implements Comparable<edu.uw.cp520.scg.util.Address>, Serializable {
    ...
    public boolean equals(Object o) {
        ...
        edu.uw.cp520.scg.util.Address address = (edu.uw.cp520.scg.util.Address) o;
     ...
     */
    @Override
    public int compareTo(edu.uw.cp520.scg.util.Address o) {
        int diff = 0;
