 ...
 * @author Tim Brown
 */
public class ClientAccount implements Account, Comparable<edu.uw.cp520.scg.domain.ClientAccount>, Serializable {
     ...
     */
    @Override
    public int compareTo(edu.uw.cp520.scg.domain.ClientAccount o) {
        int diff = 0;
